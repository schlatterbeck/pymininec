...
def taper1 (p1, p2, n, r, end = 0):
    ...
    ...     l = list (x)
    ...     print (dlm.join ('(%s, %s)' % (fmt (a), fmt (b)) for a, b in l))
    >>> p (taper1 (0.0, 31.0, 5, 0.001, 0))
    (0, 1), (1, 3), (3, 7), (7, 15), (15, 31)
    >>> p (taper1 (0.0, 31.0, 5, 0.8, 0))
    (0, 2), (2, 6), (6, 14), (14, 22.5), (22.5, 31)
    >>> p (taper1 (0.0, 31.0, 5, 0.8, 1))
    (0, 8.5), (8.5, 17), (17, 25), (25, 29), (29, 31)
    >>> p (taper1 (0.0, 31.0, 5, 0.001, 1))
    (0, 16), (16, 24), (24, 28), (28, 30), (30, 31)
    >>> p1 = np.ones (3)
    >>> p2 = np.array ([1, 2, 2]) * 31 + p1
    >>> p (taper1 (p1, p2, 5, 0.001, 0), '\\n')
    ((1, 1, 1), (2, 3, 3))
    ((2, 3, 3), (4, 7, 7))
    ((4, 7, 7), (8, 15, 15))
    ((8, 15, 15), (16, 31, 31))
    ((16, 31, 31), (32, 63, 63))
    >>> p (taper1 (p1, p2, 5, 0.001, 1), '\\n')
    ((1, 1, 1), (17, 33, 33))
    ((17, 33, 33), (25, 49, 49))
    ((25, 49, 49), (29, 57, 57))
    ((29, 57, 57), (31, 61, 61))
